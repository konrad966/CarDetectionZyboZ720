...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins LidarSubsystem_0/clk] [get_bd_pins draw_bbox_0/clk] [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins project2image_0/clk] [get_bd_pins rgb2dvi_0/PixelClk]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz/clk_in1]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins clk_wiz/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins dvi2rgb_0/pRst] [get_bd_pins rgb2dvi_0/aRst] [get_bd_pins xlconstant_0/dout]
