...
#
# Generated by export_simulation on Tue Apr 30 21:00:40 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './acc_adder.sh' script.

./acc_adder.sh -reset_run
...
./acc_adder.sh -noclean_files

For more information on the script, please type './acc_adder.sh -help'.
